    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-1.5">
        ...
        <div className="relative group">
          <User className="absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400 transition-colors group-focus-within:text-blue-600" />
          <input
            id="name"
            type="text"
            required
      ...
      <p className="text-center text-sm text-gray-600">
        ...
        {' '}to continue managing your applications
      </p>
    </form>
  );
}